<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TenantPropertyDetails.aspx.cs" Inherits="MyPrototype.TenantPropertyDetails" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <strong>
                       <asp:Label ID="lblUser" runat="server" Text="Label" CssClass="auto-style1"></asp:Label>
                    </strong>
                </div>
            </div>
                ...
                <div class="col-md-12">
                        <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" RepeatDirection="Horizontal">
                            <ItemTemplate>
                                <div class="row">
                                <div class="col-md-4">
                                    <asp:Image ID="Image1" runat="server" CssClass="img-fluid" ImageUrl='<%#DataBinder.Eval(Container.DataItem, "photo") %>' />
                                </div>
                                <div class="col-md-8">
            ...
            <br />
             ...
             <br />
                     <asp:Label ID="Label1" runat="server" Text='<%# Bind("area_size") %>'/>
                       <br /> <asp:Label ID="Label4" runat="server" Text='<%# Bind("amount") %>'/>
                        <br /><asp:Label ID="Label5" runat="server" Text='<%# Bind("city") %>'/>
                        <br /><asp:Label ID="Label6" runat="server" Text='<%# Bind("category") %>'/>
